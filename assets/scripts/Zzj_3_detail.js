...
const ACHI_ZZJ1_LV = 11;
const ACHI_ZZJ_JJ = 17;
const L1 = 20;
const L2 = 40;
const MOVE_TIME = 0.5;
...
//////////////////////////////////
    ...
    init:function(){
        ...
        this._damage = require("ComMain").gameCfgs.machinelevel[ this._lv ].damage1;         //伤害
        ...
        //this.dengji_node.width = (this._lv/DENGJI) * LENGTH;                                      //等级进度调显示长度
        ...
        this.jinjie_next_damage.string = "X " + numberShow(require("ComMain").gameCfgs.machindegree[next_dengji_jinjie].poweruprate) // 
    ...
    initYupan:function(){
        ...
        var xiaci_damage =  this._BigNum.MulNum(require("ComMain").gameCfgs.machinelevel[ dengji_lv ].damage1  ,this.doubleDamage(this._jinjie_lv) ) ;   
    ...
    loadSkin:function(){    
        ...
        if(self._assest){
            ...
            cc.loader.loadRes("Images/zhizaoji/machine_3", cc.SpriteAtlas, function (err, atlas) {             //加载图集
                ...
                var sp1 = self._assest.getSpriteFrame(str_name_1);
                var sp2 = self._assest.getSpriteFrame(str_name_2);
                    /**
                     * 加载到资源后
                     */
        ...
        // need_coin_num = this._BigNum.Div(need_coin_num , touxianjiacheng);
         ...
         if(  this._BigNum.ChargeBig(all_coins ,need_coin_num) ){
           ...
           if( next_dengji > need_lv ){
            ...
            cc.systemEvent.emit("MANCHINE_3_SHENJI");
            playerManager.coin =  this._BigNum.Sub( all_coins , need_coin_num ) ;                //扣钱
            playerManager.zhizaoji_lv[ZZJ] = next_dengji;                       //升级
        
            if(next_dengji == 3 && require("PlayerManager").first_boomer == true ){
                cc.systemEvent.emit("OPEN_NEW3");
            ...
            require("PlayerManager").achievement_jindu[ACHI_ZZJ1_LV] = playerManager.zhizaoji_lv[ZZJ];
             ...
             if( (next_dengji % 10) == 0 ){
                ...
                // this.moneyMove( this.moneynode,OBJ_X,OBJ_Y);
                //return ;
            }
    ...
    jinjieButton:function(){
        ...
        if( all_screw >= need_screw    ){
            ...
            if( next_dengji >  MAX_JINJIE_LV ){
             ...
             playerManager.zhizaoji_intensify_lv[ZZJ] = playerManager.zhizaoji_intensify_lv[ZZJ] + 1 ;                  //升级
             require("PlayerManager").achievement_jindu[ACHI_ZZJ_JJ] = playerManager.zhizaoji_intensify_lv[ZZJ];
             
             this.setStartTexiao();
             this.init();                                                           //刷新界面
             cc.systemEvent.emit("MACHINE_3_JINJIE");
             cc.systemEvent.emit("UI_CHANGE");
             console.log("进阶成功");
             this.red.active = false;
             cc.systemEvent.emit("RED_CHANGE");
    ...
    needMoneyCount(lv,next_lv){                                     //当前等级跟要升的等级
        ...
        for(var i = 0;i<sub;i++){
            sum = this._BigNum.Add( sum, machinelevel[lv+1+i].consume1 );
        }
        var touxianlv = require("PlayerManager").touxianlv;     //头衔等级
        var touxianjiacheng = require("ComMain").gameCfgs.touxian[touxianlv].jiacheng;
    ...
    moneyMove:function( obj_node, obj_x,obj_y){
        ...
        var x2 = obj_node.children[1].x   ; var y2 = obj_node.children[1].y
        var x3 = obj_node.children[2].x   ; var y3 = obj_node.children[2].y
        var x4 = obj_node.children[3].x   ; var y4 = obj_node.children[3].y
        var x5 = obj_node.children[4].x   ; var y5 = obj_node.children[4].y
        var x6 = obj_node.children[5].x   ; var y6 = obj_node.children[5].y

        //var arr_vec1 = [ cc.v2(x1,y1), cc.v2(x1+5,y1 + (obj_y - y1)*0.5 ) ,cc.v2(obj_x,obj_y) ];
        ...
        //     obj_node.children[0].x = x1; obj_nodechildren[0].y = y1;
        // },this);
        // var call2 = cc.callFunc(function(){
        //     obj_node.active = false;
        //     obj_node.children[1].x = x2; obj_node.children[1].y = y2;
        // },this);
        // var call3 = cc.callFunc(function(){
        //     obj_node.active = false;
        //     obj_node.children[2].x = x3; obj_node.children[2].y = y3;
        // },this);
        // var call4 = cc.callFunc(function(){
        //     obj_node.active = false;
        //     obj_node.children[3].x = x4; obj_node.children[3].y = y4;
        // },this);
        // var call5 = cc.callFunc(function(){
        //     obj_node.active = false;
        //     obj_node.children[4].x = x5; obj_node.children[4].y = y5;
        // },this);
        // var call6 = cc.callFunc(function(){
        //     obj_node.active = false;
        //     obj_node.children[5].x = x6; obj_node.children[5].y = y6;
        // },this);

            
        // obj_node.children[0].runAction( cc.bezierTo(MOVE_TIME,arr_vec1 ) );              //cc.sequence( cc.bezierTo(MOVE_TIME,arr_vec1 ),call1 )
         obj_node.children[1].runAction( cc.sequence( new cc.bezierTo(MOVE_TIME,arr_vec2 ),call2 ));
        // obj_node.children[2].runAction( cc.sequence( cc.bezierTo(MOVE_TIME,arr_vec3 ),call3 ));
        // obj_node.children[3].runAction( cc.sequence( cc.bezierTo(MOVE_TIME,arr_vec4 ),call4 ));
        // obj_node.children[4].runAction( cc.sequence( cc.bezierTo(MOVE_TIME,arr_vec5 ),call5 ));
        // obj_node.children[5].runAction( cc.sequence( cc.bezierTo(MOVE_TIME,arr_vec6 ),call6 ));
    },
