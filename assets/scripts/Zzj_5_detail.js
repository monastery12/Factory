...
const ACHI_ZZJ1_LV = 15;
const ACHI_ZZJ_JJ = 21;
...
//////////////////////////////////
    ...
    init:function(){
        ...
        this._damage = require("ComMain").gameCfgs.machinelevel[ this._lv ].damage5;         //伤害
        ...
        this.damage_lb.string       = self._BigNum.Show( self._BigNum.MulNum( self._damage , self.doubleDamage(self._jinjie_lv) ) );   //攻击                                 //攻击
    ...
    initYupan:function(){
        ...
        var xiaci_damage =  this._BigNum.MulNum(require("ComMain").gameCfgs.machinelevel[ dengji_lv ].damage5  ,this.doubleDamage(this._jinjie_lv) ) ;   
    ...
    loadSkin:function(){    
        ...
        if(self._assest){
            ...
            cc.loader.loadRes("Images/zhizaoji/machine_2", cc.SpriteAtlas, function (err, atlas) {             //加载图集
                self._assest = atlas;
                var str_name_1 = "type_" + self._skin_type.toString();
                var str_name_2 = "type_" + self._skin_type.toString()+"_" + self._skin_type.toString();
    ...
    shengjiButton:function(){
        ...
        var need_coin_num  = require("ComMain").gameCfgs.machinelevel[ next_dengji ].consume1;          //该等级需要的金币
         ...
         if(this._BigNum.ChargeBig(all_coins ,need_coin_num) ){
           ...
           if( next_dengji > need_lv ){
            ...
            this._money_ani.play("sell_money");
             ...
             cc.systemEvent.emit("MANCHINE_5_SHENJI");
    ...
    needMoneyCount(lv,next_lv){                                     //当前等级跟要升的等级
        ...
        for(var i = 0;i<sub;i++){
            sum = this._BigNum.Add( sum, machinelevel[lv+1+i].consume5 );
        }
