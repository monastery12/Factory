...
const ACHI_ZZJ1_LV = 13;
const ACHI_ZZJ_JJ = 19;
...
//////////////////////////////////
    ...
    init:function(){
        ...
        this._damage = require("ComMain").gameCfgs.machinelevel[ this._lv ].damage3;         //伤害
    ...
    initYupan:function(){
        ...
        var xiaci_damage =  this._BigNum.MulNum(require("ComMain").gameCfgs.machinelevel[ dengji_lv ].damage3  ,this.doubleDamage(this._jinjie_lv) ) ;   
         ...
         if( this._BigNum.ChargeBig(all_coins ,need_coin_num) ){
           ...
           if( next_dengji > need_lv ){
            ...
            this._money_ani.play("sell_money");
             cc.systemEvent.emit("MANCHINE_4_SHENJI");
    ...
    jinjieButton:function(){
        ...
        if( all_screw >= need_screw    ){
            ...
            if( next_dengji >  MAX_JINJIE_LV ){
             ...
             this.setStartTexiao();
             this.init();                                                           //刷新界面
             cc.systemEvent.emit("MANCHINE_4_JINJIE");
             cc.systemEvent.emit("UI_CHANGE");
             console.log("进阶成功");
             this.red.active = false;
             cc.systemEvent.emit("RED_CHANGE");
    ...
    needMoneyCount(lv,next_lv){                                                 //当前等级跟要升的等级
        ...
        for(var i = 0;i<sub;i++){
            sum = this._BigNum.Add( sum, machinelevel[lv+1+i].consume3 );
        }
        var touxianlv = require("PlayerManager").touxianlv;     //头衔等级
        var touxianjiacheng = require("ComMain").gameCfgs.touxian[touxianlv].jiacheng;
